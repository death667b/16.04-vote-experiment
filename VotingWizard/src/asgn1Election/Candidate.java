...
public class Candidate {
	 ...
	 * 
	 * @return <code>String</code> containing text version of
	 *         <code>voteCount</code>
	 */
	...
	/**
	 * Test if the string given is not null or has at least one non-space
	 * character
	 * 
	 * @param string <code>String</code> to test
	 * @return True if not null and has at least one non-space character. False
	 *         if null or only contains spaces.
	 */
