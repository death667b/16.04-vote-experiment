...
public class VoteCollectionTests {
	...
	private VoteCollection instanceCreateTest, vc, vcBlank;
	 ...
	 */
	@Test
	public void testCountPrimaryVotesWinner() {
		vc.countPrimaryVotes(cds);
	...
	@Test
	public void testCountPrimaryVotesLooser() {
		vc.countPrimaryVotes(cds);
	...
	public void testGetFormalCount() {
		assertEquals(689, vc.getFormalCount());
	}
	...
	public void testGetInformalCount() {
		assertEquals(14, vc.getInformalCount());
	}
