...
public class PrefElectionTests {
	...
	public void setUp() throws Exception {
		prefElect = new PrefElection("test");
	...
	public void testIsFormalNormal() {
		...
		assertTrue(prefElect.isFormal(testVote));
	}
	...
	public void testIsFormalAllOnesFail() {
		...
		assertFalse(prefElect.isFormal(testVote));
	}
